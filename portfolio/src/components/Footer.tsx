                ...
                <ul className="space-y-4">
                  {quickLinks.map((link) => (
                    <li key={link.name}>
                      <a
                        href={link.href}
                        className="text-[#D1D1C7] opacity-75 hover:opacity-100 hover:text-orange-400 transition-all duration-300 flex items-center gap-2 group"
                      >
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    {socialLinks.map((social, index) => (
                      <a
                        ...
                        className={`flex items-center gap-3 p-4 bg-white/5 backdrop-blur-sm rounded-xl border border-white/10 hover:border-white/20 transition-all duration-300 hover:bg-white/10 group ${social.color}`}
                      >
